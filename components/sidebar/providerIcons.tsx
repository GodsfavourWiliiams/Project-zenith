export const TaskIcon = ({ width, height, color }) => {
  return (
    <svg
      width={width}
      height={height}
...
export const TeamIcon = ({ width, height, color }) => {
  return (
    <svg
      width={width}
      height={height}
...
export const CalenderIcon = ({ width, height, color }) => {
  return (
    <svg
      width={width}
      height={height}
...
export const HomeIcon = ({ width, height, color }) => {
  return (
    ...
    >
      ...
      />
      <path
        d='M7.33002 14.49L9.71002 11.4C10.05 10.96 10.68 10.88 11.12 11.22L12.95 12.66C13.39 13 14.02 12.92 14.36 12.49L16.67 9.51001'
        stroke={color}
        strokeWidth='1.5'
        strokeLinecap='round'
        strokeLinejoin='round'
